...
namespace RomanTumaykin.SimpleDataAccessLayer
{
    ...
    /// </summary>
    [Guid(GuidList.guidSimpleDataAccessLayerConfigFileEditorEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private SimpleDataAccessLayerConfigFileEditorPackage editorPackage;
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidSimpleDataAccessLayerConfigFileEditorEditorFactory;
            pgrfCDW = 0;
