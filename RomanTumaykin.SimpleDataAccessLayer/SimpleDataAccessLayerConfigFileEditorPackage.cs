...
namespace RomanTumaykin.SimpleDataAccessLayer
{
	...
	// I will need to learn if I need this one
//	[ProvideMenuResource("Menus.ctmenu", 1)]
	[ProvideEditorExtension(typeof(EditorFactory), ".dal", 50, 
			  ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
			  TemplateDir = "Templates", 
			  NameResourceID = 105,
			  DefaultName = "SimpleDataAccessLayerConfigFileEditor")]
	[ProvideKeyBindingTable(GuidList.guidSimpleDataAccessLayerConfigFileEditorEditorFactoryString, 102)]
	...
	// -- commented out as it is not needed. //[ProvideEditorLogicalView(typeof(EditorFactory), VSConstants.LOGVIEWID.TextView_string)]

	[Guid(GuidList.guidSimpleDataAccessLayerConfigFileEditorPkgString)]
	public sealed class SimpleDataAccessLayerConfigFileEditorPackage : Package
	{
		/// <summary>
		...
		/// </summary>
		public SimpleDataAccessLayerConfigFileEditorPackage()
		{
